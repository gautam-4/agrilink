            ...
            <section className="contact" id="contact">
                ...
                <div className="contact_container" data-aos="fade-up">
                    <div className="contact_container-names">
                        <div className="team-name text-4xl">Error Overflow</div>
                    </div>
                    <div id="carousel" data-aos="fade-up">
                        <figure id="spinner">
                            <div className='backdrop-blur-md bg-opacity-10 bg-white'>Gautam Arora</div>
                            <div className='backdrop-blur-md bg-opacity-10 bg-white'>Ansh Singhal</div>
                            <div className='backdrop-blur-md bg-opacity-10 bg-white'>Nikhil Mehlan</div>
                            <div className='backdrop-blur-md bg-opacity-10 bg-white'>Siddharth M</div>
                            <div className='backdrop-blur-md bg-opacity-10 bg-white'>Nipun S Nair</div>
                        </figure>
                    </div>
                </div>
                <div className='link-icons flex'>
