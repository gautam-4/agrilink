...
function Hero() {
  return (
    <section className="hero flex flex-col lg:flex-row h-[90vh] relative">
      <div className="hero_overlay bg-secondary opacity-80 flex-1 lg:max-w-[450px] relative overflow-hidden">
        <img 
          src={overlayImg} 
          alt="" 
      ...
      <div className="hero_main flex-2 relative">
        <div className="hero_main-title title pt-[75px] pl-[80px]">
          Empowering Farmers Through Decentralization
        </div>
        <div className="hero_main-description mx-[90px] mt-[30px] text-[1.25em] font-[var(--font-three)] text-secondary">
        ...
        <div className="hero_main-caption absolute bottom-0 bg-[var(--accent-light)] w-full h-[120px] rounded-tr-[10px] p-[10px] ml-[5px] text-[1.08em] opacity-90">
